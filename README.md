...
- [CLAUDE.md](https://github.com/sanskrit-lexicon/MW72/blob/main/CLAUDE.md) — repository guide, correction workflow, and data-format reference.
- Corrections to the canonical source follow the shared [Cologne correction workflow](https://github.com/sanskrit-lexicon/csl-corrections/blob/main/docs/correction-workflow.md) — never edit `csl-orig` directly.

## Contents

| Path | Purpose |
|---|---|
| [`20161107/`](https://github.com/sanskrit-lexicon/MW72/tree/main/20161107) | Preparatory work (Nov 2016) for proposed mw72 digitization changes (see [issue #3](https://github.com/sanskrit-lexicon/MW72/issues/3)) |
| [`prefaces/`](https://github.com/sanskrit-lexicon/MW72/tree/main/prefaces) | Front-matter OCR (title, Preface, Directions, Abbreviations, letter-order table) + EN/RU — see [Front matter](#front-matter-prefaces) below |
| [`CITATION.cff`](https://github.com/sanskrit-lexicon/MW72/blob/main/CITATION.cff) | Machine-readable citation metadata |
...
| 2026-06 | Front-matter OCR + EN/RU translation of the 1872 preface ([`prefaces/`](https://github.com/sanskrit-lexicon/MW72/tree/main/prefaces)) |
...
|---|---|---|---|---|
| [7](https://github.com/sanskrit-lexicon/MW72/issues/7) | docs-pass: MW72 documentation review | question | minor | Structured Data |

### Solved

| # | Title | Type | Severity | Milestone |
|---|---|---|---|---|
| [1](https://github.com/sanskrit-lexicon/MW72/issues/1) | IAST convention of MW72 for vocalic 'r' | question | minor | Structured Data |
| [2](https://github.com/sanskrit-lexicon/MW72/issues/2) | vakratu? | text-correction | minor | Digitization Quality |
| [3](https://github.com/sanskrit-lexicon/MW72/issues/3) | Converting Sanskrit in MW72 from AS to slp1 | encoding | medium | Digitization Quality |
| [4](https://github.com/sanskrit-lexicon/MW72/issues/4) | MW72 IAST: use modern forms only | encoding | medium | Digitization Quality |
| [5](https://github.com/sanskrit-lexicon/MW72/issues/5) | Unfilled `</lang>` cases | bug | — | (none) |
| [6](https://github.com/sanskrit-lexicon/MW72/issues/6) | [markup] Minor mw72.txt Markup Oddities | markup | minor | Structured Data |
...
| Contributor | Commits (default branch) |
|---|---|
| Mārcis Gasūns | 22 |
| funderburkjim | 5 |
| dependabot[bot] | 1 |
...
- See [CITATION.cff](https://github.com/sanskrit-lexicon/MW72/blob/main/CITATION.cff) for machine-readable citation.
...
Applying a correction to a real line of [`mw72.txt`](https://github.com/sanskrit-lexicon/csl-orig/blob/main/v02/mw72/mw72.txt) with `updateByLine.py` (root [`CLAUDE.md`](https://github.com/sanskrit-lexicon/csl-orig/blob/main/CLAUDE.md) "Shared correction pattern"). The real current line 13 (title page) reads:
...
The [`prefaces/`](https://github.com/sanskrit-lexicon/MW72/blob/main/prefaces/README.md) folder holds a faithful OCR of the **front matter** of the printed 1872 first edition — the title page, the seven-section **Preface** (signed *Monier Williams, Oxford, May 1872*), the **Directions** for using the dictionary, the **Abbreviations** table, and the **Nāgarī / Indo-Romanic letter-order** transliteration table — transcribed from the Cologne csldoc scans, with a **Russian** translation of every page.
...
- Consolidated single-file editions: [`mw72pref_all.en.md`](https://github.com/sanskrit-lexicon/MW72/blob/main/prefaces/mw72pref_all.en.md) and [`mw72pref_all.ru.md`](https://github.com/sanskrit-lexicon/MW72/blob/main/prefaces/mw72pref_all.ru.md), regenerable via [`build_combined.py`](https://github.com/sanskrit-lexicon/MW72/blob/main/prefaces/build_combined.py).
- Full page index, signatures/dates, and conventions: [`prefaces/README.md`](https://github.com/sanskrit-lexicon/MW72/blob/main/prefaces/README.md).
- Cologne source: [mw72pref.html](https://sanskrit-lexicon.uni-koeln.de/scans/csldev/csldoc/build/dictionaries/prefaces/mw72pref.html). The digitizer running header/footer stamps were omitted as not part of the original.
