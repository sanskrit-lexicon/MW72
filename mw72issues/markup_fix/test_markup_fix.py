"""Synthetic tests for 08_markup_fix.py (MW72)."""
...
line, n = fix_trim_whitespace("<nsi> word </nsi>")
check("<nsi> trim", line, "<nsi>word</nsi>")
check("<nsi> trim n>=1", n>=1, True)
line, n = fix_trim_whitespace("<nsi>clean</nsi>")
check("<nsi> no-op", line, "<nsi>clean</nsi>")
check("<nsi> no-op n", n, 0)
